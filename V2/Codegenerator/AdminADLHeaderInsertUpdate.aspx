...
CodeFile="AdminADLHeaderInsertUpdate.aspx.cs" Inherits="AdminADLHeaderInsertUpdate" Title="ADLHeader Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblADLHeaderName" runat="server" Text="ADLHeaderName: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtADLHeaderName" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
