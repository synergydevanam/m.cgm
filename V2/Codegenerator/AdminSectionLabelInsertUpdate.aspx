...
CodeFile="AdminSectionLabelInsertUpdate.aspx.cs" Inherits="AdminSectionLabelInsertUpdate" Title="SectionLabel Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblSectionNo" runat="server" Text="SectionNo: ">
                    </asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblLabelText" runat="server" Text="LabelText: ">
                    </asp:Label>
                </td>
                <td>
