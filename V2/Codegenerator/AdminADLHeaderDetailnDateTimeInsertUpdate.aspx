...
CodeFile="AdminADLHeaderDetailnDateTimeInsertUpdate.aspx.cs" Inherits="AdminADLHeaderDetailnDateTimeInsertUpdate" Title="ADLHeaderDetailnDateTime Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblADLDateTimeID" runat="server" Text="ADLDateTimeID: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlADLDateTime" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblADLHeaderDetailID" runat="server" Text="ADLHeaderDetailID: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlADLHeaderDetail" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
