<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="CustomerOld.aspx.cs" Inherits="CustomerOld" %>
                        ...
                        <tr>
                            <td colspan="2">
                                <div id="contentAreaPlaceHolder_toursDetails_formView_panelContent">
                                    <div class="formPanelContent">
                                        <table class="detailsView">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnAdd" class="button button-blue" runat="server" Text="Add"  />
                                                        &nbsp;
                                                    </td>
                                                </tr>
                                            </tbody>
                                                ...
                                                <tr class="detailsViewRow" id="contentAreaPlaceHolder_toursDetails_formView_trMarketingUser1">
                                                    ...
                                                    <td>
                                                        <div class="requiredUsersPick">
                                                            ...
                                                            &nbsp;*<br>
                                                            <span style="display: none;" class="error" id="contentAreaPlaceHolder_toursDetails_formView_ctl09">
                                                                Required</span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <div id="contentAreaPlaceHolder_toursDetails_formView_giftsMapping_UpdatePanel2">
                                                            <div style="margin-bottom: 5px;" id="contentAreaPlaceHolder_toursDetails_formView_giftsMapping_panelDropDownGifts">
                                                                <div style="width: 280px;" emptyitemtext="None" class="RadComboBox RadComboBox_Default"
                                                                    id="ctl00_contentAreaPlaceHolder_toursDetails_formView_giftsMapping_dropDownGifts">
                                                                    <table style="border-width: 0pt; border-collapse: collapse;" summary="combobox" class="rcbDisabled">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="rcbInputCell rcbInputCellLeft" style="width: 100%;">
                                                                    ...
                                                                    <input type="hidden" name="ctl00_contentAreaPlaceHolder_toursDetails_formView_giftsMapping_dropDownGifts_ClientState"
                                    ...
                                    <table class="detailsView">
                                        <tbody>
                                            <tr class="detailsViewCommandRow">
                                                <td colspan="2">
                                                    <asp:Button ID="btnAdd0" class="button button-blue" runat="server" Text="Add"  />
                                                    &nbsp;
                                                </td>
                                            </tr>
                                        </tbody>
