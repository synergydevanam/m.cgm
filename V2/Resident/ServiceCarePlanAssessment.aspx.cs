...
public partial class Resident_ADLRecord : System.Web.UI.Page
{
    ...
    protected void ddlExistingRecord_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        a_Print.HRef = "ServiceCarePlanAssessmentPrint.aspx?Title=Service Care Plan Assessment&CarePlanDateTimeID=" + ddlExistingRecord.SelectedValue + "&ResidentID=" + Request.QueryString["ResidentID"];
        if (ddlExistingRecord.SelectedIndex != 0)
        {
