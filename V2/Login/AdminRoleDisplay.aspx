<%@ Page Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true"
    CodeFile="AdminRoleDisplay.aspx.cs" Inherits="AdminRoleDisplay" Title="Display Role By Admin" %>
    ...
    <div>
        ...
        <asp:GridView ID="gvRole" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
                ...
                <asp:TemplateField HeaderText="RoleDescription">
                    <ItemTemplate>
                        <asp:Label ID="lblRoleDescription" runat="server" Text='<%#Eval("RoleDescription") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
