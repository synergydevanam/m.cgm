...
CodeFile="AdminMenuRoleInsertUpdate.aspx.cs" Inherits="AdminMenuRoleInsertUpdate" Title="MenuRole Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblMenuID" runat="server" Text="MenuID: ">
                    </asp:Label>
                </td>
                <td>
